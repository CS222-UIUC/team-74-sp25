  ...
  const renderSelectedTypeMessage = () => {
    ...
    return (
      <div className="mt-6 p-8 rounded-lg">
        <h2 className="font-bold text-3xl text-sky-600 mb-4 text-center">Your Skin Type: {selectedSkinType}</h2>
      ...
      <div className="grid justify-center p-7">
        ...
        {!showQuiz && !selectedSkinType && (
          <>
            ...
            <HoverComponent name='Oily' onSkinTypeSelect={handleSkinTypeSelect} />
            <HoverComponent name='Dry' onSkinTypeSelect={handleSkinTypeSelect} />
            <HoverComponent name='Combination' onSkinTypeSelect={handleSkinTypeSelect} />
            <HoverComponent name='Sensitive' onSkinTypeSelect={handleSkinTypeSelect} />
            <HoverComponent name='Not sure' onSkinTypeSelect={handleSkinTypeSelect} />
          </>
        )}

        {showQuiz && (
          <div className="mt-4">
            <h1 className="font-bold text-4xl p-4 text-center">Let&apos;s determine your skin type</h1>
